...
from simple_retarget import retarget, yumi_robot
...
def joints_pose_cb(msg):
    ...
    joint_angles_left = retarget(left_arm_pos, 'left', yumi_robot, joint_angles_left)
    joint_angles_right = retarget(right_arm_pos, 'right', yumi_robot, joint_angles_right)
